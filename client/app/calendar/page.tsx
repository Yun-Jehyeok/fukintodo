  ...
  return (
    <div>
      ...
      <div className="w-full flex gap-4">
        <div className="w-[70%] max-w-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <table className="w-full">
            ...
            <tbody>
              <tr className="grid grid-cols-7">
                <td className="ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 flex flex-col justify-between">
                  <div className="font-medium text-black dark:text-white">1</div>
                  <div>
                ...
                <td className="ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4">
              ...
              <tr className="grid grid-cols-7">
                ...
                <td className="ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 flex flex-col justify-between">
                  <div className="font-medium text-black dark:text-white">13</div>
                  <div>
                    <div className="flex gap-1 items-center">
                      <div className="w-2 h-2 rounded-full bg-[#019C63]"></div>
                      <div className="text-xs flex-1 overflow-hidden text-ellipsis whitespace-nowrap">고객센터 및 로그인/회원가입 기능 개발</div>
                    </div>
                    <div className="flex gap-1 items-center">
                      <div className="w-2 h-2 rounded-full bg-[#464E64]"></div>
                      <div className="text-xs flex-1 overflow-hidden text-ellipsis whitespace-nowrap">퇴근하고싶다</div>
                    </div>
                  </div>
                </td>
                <td className="ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4">
              ...
              <tr className="grid grid-cols-7">
                ...
                <td className="ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 flex flex-col justify-between">
                  <div className="font-medium text-black dark:text-white">25</div>
                  <div>
                    <div className="flex gap-1 items-center">
                      <div className="w-2 h-2 rounded-full bg-[#019C63]"></div>
                      <div className="text-xs flex-1 overflow-hidden text-ellipsis whitespace-nowrap">집에가고싶다</div>
                    </div>
                    <div className="flex gap-1 items-center">
                      <div className="w-2 h-2 rounded-full bg-[#464E64]"></div>
                      <div className="text-xs flex-1 overflow-hidden text-ellipsis whitespace-nowrap">퇴근하고싶다퇴근하고싶다퇴근하고싶다퇴근하고싶다</div>
                    </div>
                  </div>
                </td>
                <td className="ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4">
